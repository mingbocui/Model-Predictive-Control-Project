...
while 1
	...
	[F,f] = double(O);	
	% Compute the pre-set
    % why F * A rather than A*F, F refers to H, f refers to h
...
while 1
    ...
    % [X,Y,BUTTON] = ginput(N) returns a third result, BUTTON, that contains a vector of integers specifying which mouse button was
